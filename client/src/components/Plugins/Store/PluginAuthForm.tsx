        ...
        >
          {authConfig.map((config: TPluginAuthConfig, i: number) => {
            ...
            const inputClassName =
              'flex h-10 max-h-10 w-full resize-none rounded-md border border-gray-200 bg-transparent px-3 py-2 text-sm text-gray-700 shadow-sm outline-none placeholder:text-gray-400 focus:border-gray-400 focus:bg-gray-50 focus:outline-none focus:ring-0 focus:ring-gray-400 focus:ring-opacity-0 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-500 dark:bg-gray-700 dark:text-gray-50 dark:shadow-sm dark:focus:border-gray-400 focus:dark:bg-gray-600 dark:focus:outline-none dark:focus:ring-0 dark:focus:ring-gray-400 dark:focus:ring-offset-0';
            const sharedProps = {
              id: authField,
          ...
          >
            <div className="flex items-center justify-center gap-2">
              ...
              <Save className="flex h-4 w-4 items-center" aria-hidden="true" />
            </div>
          </button>
        </form>
      </div>
