            ...
            render={({ field }) => (
              <div className="flex flex-col">
                ...
                <TextareaAutosize
                  ...
                  className="w-full resize-none rounded-xl border border-border-medium bg-transparent p-3 text-sm text-text-primary placeholder:text-text-secondary focus-visible:outline-none"
                />
