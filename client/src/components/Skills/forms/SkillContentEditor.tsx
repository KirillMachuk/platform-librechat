          ...
          render={({ field }) =>
            isEditing ? (
              <TextareaAutosize
                ...
                autoFocus
                className="w-full resize-none overflow-y-auto overflow-x-hidden bg-transparent font-mono text-sm leading-relaxed text-text-primary placeholder:text-text-secondary focus:outline-none sm:text-base"
                minRows={4}
                maxRows={16}
                onKeyDown={(e) => {
                  if (e.key === 'Escape') {
              ...
              >
                ...
                <div className="pointer-events-none sticky bottom-1/2 z-10 flex translate-y-1/2 items-center justify-center opacity-0 transition-all duration-200 group-hover/preview:opacity-100">
                  <div className="flex items-center gap-2 rounded-lg border border-border-light bg-surface-primary px-3 py-1.5 shadow-sm">
