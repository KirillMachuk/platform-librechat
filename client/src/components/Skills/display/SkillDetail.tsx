...
import { Eye, Code, User, Calendar, EarthIcon, ScrollText } from '~/components/icons';
...
export default function SkillDetail({ skill, onEdit, onDelete }: SkillDetailProps) {
  ...
  return (
    <article
      className="flex h-full min-w-0 flex-col gap-2 overflow-y-auto overflow-x-hidden px-5 pb-5"
