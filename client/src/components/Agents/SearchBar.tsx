  ...
  return (
    <div className={`relative w-full max-w-4xl ${className}`} role="search">
      ...
      <Input
        ...
        className="h-12 rounded-xl border-border-medium bg-transparent pl-12 pr-12 text-lg text-text-primary shadow-sm transition-[border-color,box-shadow] duration-200 placeholder:text-text-secondary focus:border-border-heavy focus:shadow-lg focus:ring-0"
