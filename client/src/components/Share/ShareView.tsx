...
function ShareHeader({
  ...
  return (
    <section className="mx-auto w-full px-2 pb-3 pt-4 md:px-5 md:pb-4 md:pt-6">
      <div className="bg-surface-primary/80 relative mx-auto flex w-full max-w-[60rem] flex-col gap-3 rounded-2xl border border-border-light px-4 py-4 shadow-sm backdrop-blur md:gap-4 md:rounded-3xl md:px-6 md:py-5">
