    ...
    <span className="not-prose relative inline-block h-full w-full">
      <Ariakit.HovercardProvider showTimeout={150} hideTimeout={150}>
        <div className="flex h-full items-center">
          ...
          />
          <Ariakit.HovercardDisclosure className="absolute right-2 rounded-full text-text-primary focus:outline-none">
            <VisuallyHidden>
  ...
  return (
    <div className="scrollbar-none pan-x grid w-full grid-cols-4 gap-2 overflow-x-auto overflow-y-clip">
      <OGDialog>
        ...
        <OGDialogContent className="flex max-h-[80vh] flex-col overflow-hidden rounded-lg bg-surface-primary p-0 md:max-w-[600px]">
