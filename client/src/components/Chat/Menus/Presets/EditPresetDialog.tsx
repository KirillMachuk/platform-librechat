...
const EditPresetDialog = ({
  ...
  return (
    <OGDialog open={presetModalVisible} onOpenChange={handleOpenChange} triggerRef={triggerRef}>
      <OGDialogContent className="h-[100dvh] max-h-[100dvh] w-full max-w-full overflow-y-auto overflow-x-hidden bg-white dark:border-gray-700 dark:bg-gray-850 dark:text-gray-300 md:h-auto md:max-h-[90vh] md:max-w-[75vw] md:rounded-lg lg:max-w-[950px]">
        <OGDialogTitle>
        ...
        <div className="flex w-full flex-col gap-2 px-1 pb-4 md:gap-4">
          ...
          <div className="flex justify-end gap-2 border-t border-border-medium pt-2 md:pt-4">
            <button
              ...
              className="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 md:px-4"
            >
              {localize('com_endpoint_export')}
            </button>
            <button
              onClick={submitPreset}
              className="rounded-md bg-green-500 px-3 py-2 text-sm font-medium text-white hover:bg-green-600 focus:outline-none md:px-4"
            >
