...
export default function AnswersChip({ text }: { text: string }) {
  ...
  return (
    <div
      data-testid="answers-chip"
      /* Same width ceiling as the bubble it replaces (USER_BUBBLE_WIDTH_CLASS): without it a
      ...
      className={`${USER_BUBBLE_WIDTH_CLASS} inline-flex flex-col gap-1 rounded-2xl bg-surface-secondary px-3.5 py-2 text-[length:var(--thinking-font-size)] text-text-secondary`}
    >
