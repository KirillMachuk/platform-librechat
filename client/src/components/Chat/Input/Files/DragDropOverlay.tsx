...
const DragDropOverlay = memo(({ isActive }: DragDropOverlayProps) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-dragdrop transition-opacity duration-200 ease-in-out ${
          isActive
      ...
      <div
        className={`fixed inset-0 z-dragdrop flex flex-col items-center justify-center gap-2 text-text-primary transition-all duration-200 ease-in-out ${
          isActive
            ? 'pointer-events-auto visible opacity-100'
            : 'pointer-events-none invisible opacity-0'
        } `}
      ...
      >
        ...
        <div className="flex flex-col items-center rounded-lg bg-surface-primary p-8 shadow-lg">
          <svg
