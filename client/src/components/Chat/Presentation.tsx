  ...
  return (
    <DragDropWrapper
      className={cn(
        ...
        /* Canon §4: while the frame is split the canvas has to show through the
           gap between the two cards, so this layer stops painting. It loses
           nothing — the panel group below fills the same box and keeps the card
           fill in every other case. */
        frameSplit ? 'bg-transparent' : 'bg-presentation',
      )}
    >
