...
/* Icons that keep lucide's geometry: the two subjects Phosphor never drew
   ...
   `MessageCircleDashed` left this list 11.08: the temporary chat's subject in
   the book is a dashed CLOCK, and Phosphor draws that one — ClockCountdown. */
const CUSTOM = {
