...
| A PROCEED run (no plan card) still gets the standalone running card with phase statuses | unit  | `client/src/components/Chat/Messages/DeepResearch/__tests__/ProgressCard.spec.tsx#falls back to the three research phases` | covered |
