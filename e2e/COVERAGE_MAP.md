...
| On a phone the «Thoughts» header, «Ещё N» under a plan and the ✕ that cancels a research reach 44px to a finger without covering a neighbour's centre (design review 02.09, item 6) | e2e | `e2e/specs/mock/card-tap-targets.spec.ts#the «Thoughts» header, «Ещё N» under a plan and the cancel ✕` | covered |
