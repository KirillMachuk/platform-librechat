...
| Text whose colour comes from a clipped gradient stays readable when selected — every zeroing class names a selection colour (owner r28) | unit  | `client/src/components/Chat/Cards/__tests__/shimmerContract.spec.ts#every one of them names a selection colour` | covered |
