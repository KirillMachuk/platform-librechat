...
| A SHARED conversation shows the same chips as the chat (DR command, ask answers) instead of the raw marker text | unit  | `client/src/components/Share/__tests__/Message.chips.spec.tsx#hides the DR start row entirely` | covered |
