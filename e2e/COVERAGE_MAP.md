...
| A reasoning card expanded during streaming stays expanded through finalization (r24 audit) | unit  | `client/src/components/Chat/Messages/Content/__tests__/ContentParts.autoExpand.test.tsx#re-seeds a user-expanded card` | covered |
...
| One waiting word: streaming thoughts carry the shimmering «Думаю…» header, finished — static «Мысли» (owner r24) | unit  | `client/src/components/Chat/Messages/Content/__tests__/Reasoning.label.spec.tsx#streams under the shimmering` | covered |
