...
| The highlighted plan step is the one the RUN reported, never derived from the progress fraction (owner r27) | unit  | `client/src/components/Chat/Messages/DeepResearch/__tests__/RunFooter.spec.ts#FAILS ON PRE-FIX CODE: the first research round is step 1` | covered |
