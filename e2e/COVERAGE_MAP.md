...
| iPhone/iPad «+» sheet: one attach tile (native Safari sheet covers the split) | unit  | `client/src/components/Chat/Input/__tests__/PlusSheet.spec.tsx#merges the three tiles into one on Apple touch devices` | covered |
...
| PDF fits across a phone screen and scrolls down through it  | e2e   | `e2e/specs/mock/file-preview.spec.ts#fits a PDF across a phone screen and scrolls down through it`             | covered |
