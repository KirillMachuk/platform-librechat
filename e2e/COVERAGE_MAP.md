...
| The shared-link projection carries `drKind`, without which every DR surface on a shared page renders as plain text | unit  | `packages/data-schemas/src/methods/share.test.ts#should carry drKind through to the shared projection` | covered |
