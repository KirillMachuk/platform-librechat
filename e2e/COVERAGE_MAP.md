...
| The running research card wears the plan card's frame with live step statuses (r25 пакет Б) | unit  | `client/src/components/Chat/Messages/DeepResearch/__tests__/ProgressCard.spec.tsx#falls back to the three research phases` | covered |
...
| Stop lives in the running card's header and progress is announced to assistive tech | unit  | `client/src/components/Chat/Messages/DeepResearch/__tests__/ProgressCard.spec.tsx#puts Stop in the header` | covered |
