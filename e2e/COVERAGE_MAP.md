...
| The waiting word does not change design mid-wait: the brain marks the FOLDED thinking block only (owner r26) | unit  | `client/src/components/Chat/Cards/__tests__/ThinkingReasoning.spec.tsx#the brain marks the FINISHED block only` | covered |
