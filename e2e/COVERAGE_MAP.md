...
| Inside a code block a newline is content: a copied code line keeps it | e2e | `e2e/specs/mock/message-actions.spec.ts#a code line keeps its newline` | covered |
...
| The trimming logic itself: paragraph break, `<pre>`, images in the tail, inert blocks, text fields, direction | unit | `client/src/utils/__tests__/selectionEnd.spec.ts#a paragraph selected up to the start of the next block ends at its last character` | covered |
