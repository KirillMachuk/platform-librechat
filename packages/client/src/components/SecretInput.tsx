...
import { Eye, EyeOff, Copy, Check } from '~/components/icons';
        ...
        >
          {showCopy && (
            <button
              ...
              className={cn(
                'tap-target inline-flex size-7 shrink-0 items-center justify-center rounded-md text-text-secondary transition-colors duration-150 [&>svg]:block',
                disabled || !value
