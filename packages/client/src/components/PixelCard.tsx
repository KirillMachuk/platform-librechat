...
export default function PixelCard({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'relative isolate grid select-none place-items-center overflow-hidden rounded-lg border border-border-light shadow-sm transition-colors duration-200 ease-in-out',
          className,
        )}
        style={{
          width: '100%',
