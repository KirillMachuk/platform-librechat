...
const ResizableHandleAlt = ({
  ...
  <Separator
    className={cn(
      'group relative flex w-px items-center justify-center bg-border after:absolute after:inset-y-0 after:left-1/2 after:w-1 after:-translate-x-1/2 focus-visible:outline-none',
      className,
    )}
    {...props}
  >
