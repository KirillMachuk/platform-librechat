...
export function createCreditMonthModel(mongoose: typeof import('mongoose')): Model<t.ICreditMonth> {
...
export function createCreditSpendModel(mongoose: typeof import('mongoose')): Model<t.ICreditSpend> {
