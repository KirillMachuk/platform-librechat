...
export const AskUserToolDefinition = Object.freeze({
  ...
  description: [
    ...
    'Never restate the questions in your message text, and write NOTHING after the call — the card is',
    'the whole message and any closing sentence under it is hidden. After calling this tool, END your',
    'turn immediately; the answers',
